...
#     print(f"  Caratteri medi per pagina: {avg_chars:.0f}")

#     if avg_chars < MIN_CHARS_PER_PAGE:
#         print("  → PyMuPDF non riesce, provo pdfminer...")
#         pages = extract_text_pdfminer(pdf_path)
#         avg_chars2 = sum(p["char_count"] for p in pages) / len(pages) if pages else 0
#         print(f"  → pdfminer: {avg_chars2:.0f} caratteri medi per pagina")
#     else:
#         print("  → Estrazione nativa OK")
...
#     """
#     Estrazione alternativa con pdfminer per PDF con encoding non standard.
#     """
#     pages = []
#     try:
